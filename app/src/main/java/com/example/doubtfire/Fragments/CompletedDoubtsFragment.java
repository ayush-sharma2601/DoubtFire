...
public class CompletedDoubtsFragment extends Fragment {
    View view;
    FirebaseUser fbUser;
    RecyclerView feedRV;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.profile_completed_fragment,container,false);
        ...
        adapter = new MyDoubtsAdapter(data,1);
        ...
        imageQuery.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                ...
                if(image.isSolved.equals("solved"))
